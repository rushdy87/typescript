...
function () {
  ...
  Sync.prototype.save = function (data) {
    ...
    if (id) {
      return axios_1.default.put("{this.rootUrl}/".concat(id), data);
    } else {
...
var User_1 = require("./models/User"); // After Refactoring
...
var name = user.attributes.get('name');
var age = user.attributes.get('age');
user.sync.save({
  id: id,
  name: name,
  age: age
