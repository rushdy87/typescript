...
var UserShow = /*#__PURE__*/function (_View_1$View) {
  ...
  _createClass(UserShow, [{
    ...
    value: function template() {
      return "\n      <div>\n        <h1>User Details</h1>\n        <div>\n          User Name: ".concat(this.model.get('name'), "\n        </div>\n        <div>\n          User Age: ").concat(this.model.get('age'), "\n        </div>\n      </div>\n    ");
    }
  }]);
...
var UserList = /*#__PURE__*/function (_CollectionView_1$Col) {
  ...
  _createClass(UserList, [{
    key: "renderItem",
    value: function renderItem(modle, itemParent) {
      new UserShow_1.UserShow(itemParent, modle).render();
    }
  }]);
  ...
  _createClass(Model, [{
    ...
    value: function fetch() {
      ...
      this.sync.fetch(id).then(function (response) {
        _this.set(response.data); // we refreence to this.set because it has {this.attributes.set, and this.events.trigger}
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    key: "buildUser",
    value: function buildUser(atters) {
      return new User(new Attributes_1.Attributes(atters), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
    }
  }, {
